...
locals {
  ...
  github-username = "xxxxxxxxxxxxxxxx"                              # you need to change this line
  github-token = "xxxxxxxxxxxxx"      # you need to change this line
  key_pair="mk"            # you need to change this line
  pem_key_address = "C:/Users/xxxxxx/.ssh/key.pem"              # you need to change this line
}
