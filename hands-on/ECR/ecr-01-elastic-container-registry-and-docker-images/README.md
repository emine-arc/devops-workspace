...
```bash
docker image tag todo-app:latest xxxxxxxxxxx.dkr.ecr.us-east-1.amazonaws.com/student1-repo/todo-app:latest
```
docker images
- Push the image to your ECR repository and show the pushed image on AWS ECR Console.
...
```bash
docker run --name todo-v1 -dp 80:3000 xxxxxxxxxxxxxx.dkr.ecr.us-east-1.amazonaws.com/student1-repo/todo-app:latest # container olusturuyoruz.
```
...
```bash
docker pull xxxxxxxxxxxxx.dkr.ecr.us-east-1.amazonaws.com/student2-repo/todo-app:latest # image repoya cekiyoruz
docker run -dp 80:3000 xxxxxxxxxxxxxx.dkr.ecr.us-east-1.amazonaws.com/student2-repo/todo-app:latest # yeni olusturgumuz container image calistir
```
...
aws ecr batch-delete-image \
      --repository-name student2-repo/todo-app \
      --image-ids imageTag=latest  # repository silme komutu
```
...
https://medium.com/@ibrahimhizlioglu/aws-fargate-ecs-i%CC%87le-%C3%B6l%C3%A7eklenebilir-uygulamalar-796b82d102c6


https://aws.plainenglish.io/container-orchestration-using-aws-ecs-fargate-7ef261fbb9f2