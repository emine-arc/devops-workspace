...
```bash
$ aws configure #access key vs goruyoruz
```
...
linklerden daha detayli bakabiliriz
...
https://registry.terraform.io/providers/hashicorp/aws/latest/docs (browser'a provider.tf file aws terraform yazilmasi)