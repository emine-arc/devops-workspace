...
provider "aws" {
  region = "us-east-1"
#  secret_key = "AKIAYYNLY2KMEPBBBLWH"
#  access_key = "AGaZWACU30lu9Q6HAFJDoXYzX3vX+HSIC7b6Dvdp"
}
...
resource "null_resource" "config" {
  ...
  provisioner "file" {
    source = "~/.ssh/mikemi02.pem"
    destination = "/home/ec2-user/mikemi02.pem"
  }
